...
tmax = 8000.0, ! max sim. time, in units of 1/wci
...
! simulation domain
nx = 1, ny = 4, nz = 180,  ! total number of cells along each dim
xmax = 1., ymax = 0.4, zmax = 90.,  ! max lengths of each dim
...
inj_waves_bv = .false., ! inject waves via B & V fields
...
n_diag_particle = 2000, ! frequency at which to write particles within a volume
