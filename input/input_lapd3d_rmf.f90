...
! simulation domain
nx = 80, ny = 80, nz = 200,  ! total number of cells along each dim
xmax = 4., ymax = 4., zmax = 100.,  ! max lengths of each dim
...
inj_waves_b_rmf = .true.,  ! inject 3d RMF antenna waves via B field (read in from files)
...
ppcx(1:5) = 5, ! number of particles per cell along x 
ppcy(1:5) = 5, ! number of particles per cell along y 
ppcz(1:5) = 5, ! number of particles per cell along z 
...
mesh_mpio = .true., ! use MPI/IO to write mesh files
