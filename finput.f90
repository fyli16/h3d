...
! use MPI IO instead of traditional binary output
MPI_IO_format = .true.

! ------------------ global simulation info -----------!
maximum_simulation_time=2000.0, 
t_begin=0.0, t_end=2000.0, 
dtwci=0.010,  ! normalized dt
...
nodey=2, nodez=28  ! number of nodes along y, z
